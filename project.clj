...
(defproject org.openvoxproject/trapperkeeper-metrics "2.3.1-SNAPSHOT"
  ...
  :managed-dependencies [[org.clojure/clojure "1.12.5"]
                         ...
                         [org.jolokia/jolokia-server-core "2.6.0"]
                         [org.jolokia/jolokia-service-jmx "2.6.0"]
                         [org.jolokia/jolokia-service-serializer "2.6.0"]
